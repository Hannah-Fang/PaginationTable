...
function getPagination (feedbackData = [], currentRowsShown) {
  ...
  for(i=0; i<numPages; i++){
    let pageNum = i+1;
    $("#pagination").append('<li class="page-item" id="pageItem" rel='+ i +'><a class="page-link" href="#">'+ pageNum +'</a></li>')
  }
  $('#data tr').hide(); //隱藏所有資料
  ...
  $('#pagination li').on('click', function(){
    ...
    console.log("prevPage b",prevPage);
    ...
    if($(this).attr("id") === "pageItem"){
      ...
      prevPage = currPage;
      console.log("prevPage a",prevPage);
    } 
...
$("#maxRows").on('change',function (e) {
  currentRowsShown = document.getElementById('maxRows').value;
